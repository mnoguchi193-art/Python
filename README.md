...
| [ai/](ai/) | AGI-inspired toy demos: neural net, Q-learning, A*, memory, cognitive agent, transfer learning, model-based RL (Dyna-Q), genetic algorithm, optimizer comparison (SGD/momentum/Adam), MCTS |
